...
from src.ingestion.books.pass_01_uses_this_book_parser import BookParser
...
def save_all_parsed_books(skip_txt_parsing=False):
    ...
    output_dir = Config().PROCESSED_BOOKS_PATH
    ...
    chapters_file = Config().PROCESSED_BOOKS_PATH / 'all_chapters.json'
