...
def scrape_all_characters(wiki_all_pages_titles_file, output_dir, delay=1.0, resume_from=None):
    ...
    # Scrape all pages
    stats = scraper.scrape_character_list(character_names=pages, output_dir=output_dir, delay=delay)
...
def main():
    ...
    scrape_all_characters(wiki_all_pages_titles_file=wiki_all_pages_titles_file, output_dir=output_dir, delay=1.0)
