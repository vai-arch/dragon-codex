...
EXCLUDE_CATEGORIES = [
    ...
    "Aes_Sedai_positions",
    "High_Ranking_Aes_Sedai",
    "Middle_Ranking_Aes_Sedai",
    "Low_Ranking_Aes_Sedai",
    "Accepted",
    "Novices",
    ...
    "Attendants",
    "Council_of_Nine",
    "Counsels_of_Far_Madding",
    "Mayors_and_governors",
    "Village_Councilors",
    "Nobility",
    "High_Nobility_of_Tear",
    "Noble_houses",
    "Nobles",
    "High_Seats",
    "Major_Houses_of_Andor",
    "Government",
    "Ruling_bodies",
    "Politics",
    "Headmistresses",
    ...
    "Crossroads_of_Twilight_chapter_summaries",
    "Knife_of_Dreams_chapter_summaries",
    "Lord_of_Chaos_chapter_summaries",
    "New_Spring_chapter_summaries",
    "The_Dragon_Reborn_chapter_summaries",
    "The_Eye_of_the_World_chapter_summaries",
    "The_Fires_of_Heaven_chapter_summaries",
    "The_Gathering_Storm_chapter_summaries",
    "The_Great_Hunt_chapter_summaries",
    "The_Path_of_Daggers_chapter_summaries",
    "The_Shadow_Rising_chapter_summaries",
    "Towers_of_Midnight_chapter_summaries",
    "Winter's_Heart_chapter_summaries",
    "Chapter_summaries",
    "Chapter_summaries_crown_of_swords",
    "Book_glossaries",
    "Glossary",
    "Glossary_Only",
...
PROPHECIES_CATEGORIES = {"Prophecies", "Foretellings", "Foreseen events", "Foreseen people"}
...
# GENDER
# =============================================================================
GENDER_CATEGORIES = {"Men": "male", "Women": "female"}
