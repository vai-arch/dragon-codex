...
def check_prerequisites() -> bool:
    ...
    required_paths = ["data/raw/books", "build_character_list.py", "verify_chapters.py", "create_books_structured.py"]
...
def create_output_directories():
    ...
    directories = ["data/processed", "data/metadata"]
...
def main():
    ...
    # Define tasks
    tasks = [
        {"script": "create_books_structured.py", "description": "Create books_structured.json", "step": 1},
        {"script": "verify_chapters.py", "description": "Verify chapter extraction", "step": 2},
        {"script": "build_character_list.py", "description": "Build character list", "step": 3},
    ]
